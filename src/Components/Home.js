        ...
        <div className='w-100 row'>
          ...
          <div className='col-md'>
            ...
            <div id='About' className='collapse show About' data-bs-parent='#accordian'>
              ...
              <h1>World leading Full Stack <br/> Developer</h1>
              <br/>
              ...
              <br/>
              <button className="btn btn-danger" id='btn' type="button">Download CV</button>
              <br/>
              <br/>
              <div className="other-details">
                <div className="start bg-danger">
                  <span>Name: </span><br/>
            ...
            <div id='Skill' className='collapse' data-bs-parent='#accordian'>
          ...
          <br/><br/>
              ...
              <div id='accordian2'>
                <div className="d-flex gap-2">
                  <a href='#web' className='btn btn2' data-bs-toggle='collapse'>Web Development</a>
                  <a href='#lang' className='btn btn2' data-bs-toggle='collapse'>Languages</a>
                  <a href='#database' className='btn btn2' data-bs-toggle='collapse'>Database</a>
                  <a href='#other' className='btn btn2' data-bs-toggle='collapse'>Other Skills</a>
                </div>
                ...
                <div className="collapse" id='other' data-bs-parent='#accordian2'>
                  <div className="some2 row w-100">

                    <div className="card skill-one col-md bg-dark text-light p-1">
            ...
            <div id="demo" className="carousel slide" data-bs-ride="carousel">
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <p>Netflix Clone</p>
                  <img src={two} alt="Los Angeles" className="d-block img-fluid mx-auto" />
                </div>
                <div className="carousel-item">
                  <p>E-Commerce</p>
                  <img src={three} alt="Chicago" className="d-block img-fluid mx-auto" />
                </div>
                <div className="carousel-item">
                  <p>Wallpaper Download</p>
                  <img src={four} alt="Chicago" className="d-block img-fluid mx-auto" />
                </div>
                <div className="carousel-item">
                  <p>Weather Deshboard</p>
                  <img src={five} alt="Chicago" className="d-block img-fluid mx-auto" />
                </div>
                <div className="carousel-item">
                  <p>Space Blog</p>
                  <img src={six} alt="Chicago" className="d-block img-fluid mx-auto" />
                </div>
                <div className="carousel-item">
                  <p>Tourism Web</p>
                  <img src={seven} alt="Chicago" className="d-block img-fluid mx-auto" />
                </div>
                <div className="carousel-item">
                  <p>Furniture Appoinment</p>
                  <img src={eight} alt="Chicago" className="d-block img-fluid mx-auto" />
                </div>
                <div className="carousel-item">
                  <p>Caffe Reservation</p>
                  <img src={nine} alt="Chicago" className="d-block img-fluid mx-auto" />
                </div>
                <div className="carousel-item">
                  <p>Quiz Web Application</p>
                  <img src={ten} alt="Chicago" className="d-block img-fluid mx-auto" />
                </div>
              </div>
